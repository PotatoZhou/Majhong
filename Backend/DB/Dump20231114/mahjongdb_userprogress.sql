...
CREATE TABLE `userprogress` (
  ...
  KEY `user_id` (`user_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `userprogress_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `userprogress_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `game` (`game_id`)
...
-- Dump completed on 2023-11-14 12:58:37
